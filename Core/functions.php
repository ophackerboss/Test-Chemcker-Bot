...
$url = "https://api.telegram.org/bot8051824857:AAFN3ppY7bgYDSR2kMCprSXvAS9bX3kYXnY/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
